...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/vrabbi/terraform-provider-akamai
export TERRAFORM_PROVIDER_VERSION ?= 7.0.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-akamai
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/akamai/terraform-provider-akamai/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-akamai_${TERRAFORM_PROVIDER_VERSION}
